...
namespace MafiaAPI.Migrations
{
    ...
    [Migration("20210703071355_initial_migration")]
            ...
            modelBuilder.Entity("MafiaAPI.Models.Boss", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Rico",
                            LastName = "Patricio",
                            LastSeen = new DateTime(2021, 7, 3, 9, 13, 55, 264, DateTimeKind.Local).AddTicks(8649),
                            Money = 5000
                        },
                        new
                        {
                            ...
                            LastName = "Rodrigo",
                            LastSeen = new DateTime(2021, 7, 3, 9, 13, 55, 268, DateTimeKind.Local).AddTicks(3431),
                            Money = 5000
                        });
                });
            ...
            modelBuilder.Entity("MafiaAPI.Models.PerformingMission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            AgentId = 1L,
                            CompletionTime = new DateTime(2021, 7, 3, 9, 13, 55, 272, DateTimeKind.Local).AddTicks(3443),
                            MissionId = 1L
                        },
                        new
                        {
                            Id = 2L,
                            AgentId = 3L,
                            CompletionTime = new DateTime(2021, 7, 3, 9, 13, 55, 272, DateTimeKind.Local).AddTicks(3994),
                            MissionId = 2L
                        });
                });
